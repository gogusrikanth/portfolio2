    ...
    <section className="home-section">
      ...
      <div className="about">
        ...
        <p>
          ...
          learn new ones in a dynamic environment.<br></br>
          <br></br>
          ...
          enhance my technical proficiency.<br></br>
          <br></br>
          ...
          teaching skills and presentation abilities.<br></br>
          <br></br>I am always eager to embrace new challenges and opportunities
          for growth. My passion for continuous learning and self-awareness
          helps me adapt quickly and contribute effectively to any team. Feel
          free to explore my portfolio to see some of the projects I've worked
          on and reach out if you'd like to connect or collaborate.
        </p>
